...
export const NEXT_PUBLIC_URL = 'https://cb-commerce-frames-coral.vercel.app';
...
export const PRODUCT_PRICE_USD = '4';
export const ITEM_DESCRIPTION = 'london picture';
export const ITEM_TITLE = 'London';
export const REDIRECT_URL = ''; //optional
export const IMAGE_NAME = 'cast.png';
